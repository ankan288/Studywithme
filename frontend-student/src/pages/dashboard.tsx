...
import { LayoutDashboard, LogOut, RefreshCcw, Home, BookOpen } from 'lucide-react';
import { dashboardApi, DashboardMetrics } from '@/utils/dashboardApi';

// Components
import { ProgressSummary } from '@/components/dashboard/ProgressSummary';
import { DepthAnalytics } from '@/components/dashboard/DepthAnalytics';
import { EthicsMonitor } from '@/components/dashboard/EthicsMonitor';
...
export default function DashboardPage() {
    ...
    return (
        <>
            <Head>
                <title>Dashboard - StudyWithMe</title>
            </Head>
                ...
                <header className="bg-white border-b border-slate-200 h-16 flex items-center justify-between px-6 shadow-sm sticky top-0 z-10">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <nav className="flex items-center gap-2">
                            <Link href="/" className="flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-slate-800 px-3 py-1.5 rounded-lg hover:bg-slate-50">
                                <Home size={16} />
                                Home
                            </Link>
                            <Link href="/learn" className="flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-slate-800 px-3 py-1.5 rounded-lg hover:bg-slate-50">
                                <BookOpen size={16} />
                                Learn
                            </Link>
                        </nav>
