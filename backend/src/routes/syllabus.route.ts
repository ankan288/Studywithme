...
router.post('/', (req: Request, res: Response) => syllabusController.createSyllabus(req, res));

// GET /api/syllabus - Get all syllabi
router.get('/', (req: Request, res: Response) => syllabusController.getAllSyllabi(req, res));

// GET /api/syllabus/:id - Get syllabus by ID
router.get('/:id', (req: Request, res: Response) => syllabusController.getSyllabus(req, res));

// GET /api/syllabus/:syllabusId/topic/:topicId - Get enriched topic details
router.get('/:syllabusId/topic/:topicId', (req: Request, res: Response) => syllabusController.getTopicDetails(req, res));
...
router.post('/learning-path', (req: Request, res: Response) => syllabusController.createLearningPath(req, res));

// GET /api/syllabus/learning-path/:pathId - Get learning path
router.get('/learning-path/:pathId', (req: Request, res: Response) => syllabusController.getLearningPath(req, res));

// GET /api/syllabus/user/:userId/paths - Get all learning paths for user
router.get('/user/:userId/paths', (req: Request, res: Response) => syllabusController.getUserLearningPaths(req, res));

// POST /api/syllabus/learning-path/:pathId/complete - Mark module as complete
// Body: { moduleId, score, timeSpent, incorrectAreas }
router.post('/learning-path/:pathId/complete', (req: Request, res: Response) => syllabusController.completeModule(req, res));
...
router.post('/questions', (req: Request, res: Response) => syllabusController.generateQuestions(req, res));

// POST /api/syllabus/exam - Generate mock exam
// Body: { syllabusId, duration?, totalMarks?, pattern?, focusTopics? }
router.post('/exam', (req: Request, res: Response) => syllabusController.generateExam(req, res));

// POST /api/syllabus/revision - Generate quick revision quiz
// Body: { syllabusId, topicIds? }
router.post('/revision', (req: Request, res: Response) => syllabusController.generateRevision(req, res));

// POST /api/syllabus/adaptive-test - Generate adaptive assessment based on performance
// Body: { syllabusId, userId }
router.post('/adaptive-test', (req: Request, res: Response) => syllabusController.generateAdaptiveTest(req, res));

// POST /api/syllabus/submit - Submit assessment answers
// Body: { questionSetId, userId, answers: { questionId: answer } }
router.post('/submit', (req: Request, res: Response) => syllabusController.submitAssessment(req, res));

// ==================== PROGRESS ====================

// GET /api/syllabus/progress/:userId/:syllabusId - Get user progress
router.get('/progress/:userId/:syllabusId', (req: Request, res: Response) => syllabusController.getUserProgress(req, res));
